                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-6 d-flex d-sm-block flex-column align-items-center'>
                            ...
                            <h1 className=' text-black fw-bold text-center text-sm-start'>cook & joy</h1>
                            <h4 className='mb-5 text-black fw-bold text-center text-sm-start'>KITCHEN & RESTAURANT</h4>
